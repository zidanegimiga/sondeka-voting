  ...
  return(
    <div className={styles.heroWrapper}>
      ...
      <div className={styles.layer1}>
        <div className={styles['strokedText'] + ' ' + styles['layer1Left']}> 2023</div>
        <div className={styles['layer1Main']}> SOND3KA</div>
        <div className={styles.layer1Element}><LogoElement /></div>
        <div className={styles['strokedText'] + ' ' + styles['layer1Right']}> 2023</div>
      </div>

      <div className={styles.layer2}>
        <div className={styles['strokedText'] + ' ' + styles.layer2Left}>AWARDS</div>
        ...
        <div className={styles['strokedText'] + ' ' + styles.layer2Right}>SONDEKA</div>
      </div>

      <div className={styles.layer3}>
        <div className={styles.strokedText + ' ' + styles.layer3Left}>SOND3KA 2023</div>
        <div className={styles.layer3Element}> <Layer3Element/> </div>
