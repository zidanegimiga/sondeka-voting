...
export const getStaticProps = async ({ params }) => {
  ...
  const category = await fetch(`https://sondeka-voting-api.cyclic.app/admin/categories/${categoryId}`, { cache: "force-cache" }).then(res => res.json())
...
export const getStaticPaths = async () => {
  ...
  const categories = await fetch(`https://sondeka-voting-api.cyclic.app/admin/categories/allCategories`, { cache: "force-cache" }).then(res => res.json())
